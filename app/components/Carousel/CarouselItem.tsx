...
export const CarouselItem = ({ heroImg, titleImg }: CarouselItemType) => {
  return (
    <motion.div className="mx-auto aspect-video lg:aspect-[3/1] max-w-[92%] relative">
      ...
      <motion.section
        ...
        className="w-full flex flex-col absolute z-10 bottom-0 pl-6 pr-3 pb-2 lg:max-w-[37%] 2xl:max-w-[34%] lg:top-[20%] 2xl:top-[30%] lg:pl-9 xl:pl-12 lg:pr-0 lg:pb-0"
      >
